...
infoln "Joining bluL1 peer to the channel..."
joinChannel 1
infoln "Joining bluL2 peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for bluL1..."
setAnchorPeer 1
infoln "Setting anchor peer for bluL2..."
setAnchorPeer 2
